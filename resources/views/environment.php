...
define('DAA_SUBNAME', 'Developer & Design'); // Subname WebSite
define('DAA_SUBDESCRIPTION', 'Software Engineer end Full Stack Developer Freelancer Front-end & Back-end of São Paulo/SP'); // Subname WebSite
...
/**
 *
 *   Unity | Form PHPMailer
 *
 * @author Darlis A. Amorim _ eu@darlisalvesamorim.dev _
 ...
 *
 */
define('MAIL_SENDER', 'Unity | Form PHPMailer');    // Remetente do E-mail SMTP - SMTP Email Sender
define('MAIL_HOST', 'smtp.hostinger.com');      // SMTP do Servidor -  SMTP Server ( 'smtp.example.com' )
define('MAIL_USER', 'EMAIL@USER.SMTP');     // E-mail do usuário SMTP - SMTP User Email
define('MAIL_PASS', 'SECRET');    // Senha do e-mail usuário ( SMTP )
define('MAIL_PORT', '465');     // Portas Padrões - Default Doors ( SSL=465,  TLS=587 or POP=993 )
define('MAIL_MODE', 'ssl');     // Encriptação - Encryption ( SSL, TLS, POP or PHPMailer::ENCRYPTION_SMTPS )
define('MAIL_TESTER', 'TESTING@EMAIL.TEST');    // Teste de E-mail - Email Test


/*
 *  Time Zone
 */
define('MAIL_ZONE', 'America/Sao_Paulo');


/*
 *  Time and redirection
 */
define('MAIL_REDIRECT', 'http://MY/URL'); // Redirect URL ( https://www.darlisalvesamorim.com )
define('MAIL_REDIRECT_TEMP', '3000'); // Redirection Time ( 3000 = 3 Seconds )
